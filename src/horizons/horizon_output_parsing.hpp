...
public:
    ParsedHorizonGeneratedEphemeris(HorizonGeneratedEphemeris& generated_ephemeris) : ephemeris_data(new HorizonEphemerisData[generated_ephemeris.getRawEphemerisData().size()])
    {
        for (unsigned int i = 0; i < generated_ephemeris.getRawEphemerisData().size(); i++)
        {
